...
class Sphero {
     ...
     */
    move(move) {
        console.log(this.state, SPHERO_VARS.getModuleOf(this.identifier) === SPHERO_VARS.ACTIVE_MODULE, this.state !== SPHERO_VARS.STATES.INACTIVE);
        if(SPHERO_VARS.getModuleOf(this.identifier) === SPHERO_VARS.ACTIVE_MODULE && this.state !== SPHERO_VARS.STATES.INACTIVE)
